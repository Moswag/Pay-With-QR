...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean loginStatus=sessionManager.isUserLoggedIn();
        if(loginStatus){
            HashMap<String, String> username=sessionManager.getUserDetails();
            String name=username.get(UserSessionManager.KEY_Name);
            ...
            Toast.makeText(LoginActivity.this,"Please login to Proceed ",Toast.LENGTH_LONG).show();
        }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(res.equals("success")){
                                sessionManager.createUserLoginSession(res,mEmail, mPassword);
                                Toast.makeText(getApplicationContext(),"Welcome "+res,Toast.LENGTH_LONG).show();
                                startActivity(new Intent(LoginActivity.this,NavigationDrawer.class));
                            }
                            else{
